...
<body class="bg-blue-400 text-gray-900 h-screen w-screen antialiased">
    <div class="h-full w-full flex flex-col justify-center items-center px-2">
        ...
        <div class="w-full md:w-1/2 lg:w-1/4 rounded-md p-4 shadow-lg bg-white my-2">
            <h4 class="my-4 text-xl font-medium">Register</h4>
            ...
            <form class="" action="<?php echo base_url('register/store') ?>" method="post">
                <div class="my-3 mb-3 pt-0">
                    <label for="">nama</label>
                    <input name="name" type="text" placeholder="Nama" class="mt-1 px-3 py-3 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full" required/>
                </div>
        ...
        <div class="w-full md:w-1/2 lg:w-1/4 p-2 my-1 text-center">
            <p class="my-1">*sudah punya akun?</p>
