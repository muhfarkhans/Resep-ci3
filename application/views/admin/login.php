...
<body class="bg-blue-400 text-gray-900 h-screen w-screen antialiased">
    <div class="h-full w-full flex flex-col justify-center items-center px-2">
        ...
        <div class="w-full md:w-1/2 lg:w-1/4 rounded-md p-4 shadow-lg bg-white my-2">
            <h4 class="my-4 text-xl font-medium">Login admin</h4>
            ...
            <form class="" action="<?php echo base_url('login/store_admin') ?>" method="post">
                <div class="mt-4 mb-3 pt-0">
                    <label for="">Username</label>
                    <input name="username" type="text" placeholder="Email" class="mt-1 px-3 py-3 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full" required/>
                </div>
